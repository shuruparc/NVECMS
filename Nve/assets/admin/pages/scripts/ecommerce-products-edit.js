var EcommerceProductsEdit = function () {
            ...
            init: {
                ...
                FileUploaded: function(up, file, response) {
                    ...
                    if (response.result && response.result == 'OK') {
                        ...
                        $('#uploaded_file_' + file.id + ' > .status').removeClass("label-info").addClass("label-reception").html('<i class="fa fa-warning"></i> Failed'); // set failed upload
                        Metronic.alert({type: 'reception', message: 'One of uploads failed. Please retry.', closeInSeconds: 10, icon: 'warning'});
                    }
                },
         
                Error: function(up, err) {
                    Metronic.alert({type: 'reception', message: err.message, closeInSeconds: 10, icon: 'warning'});
                }
            }
        });
    ...
    var initComponents = function () {
        ...
        $('.maxlength-handler').maxlength({
            limitReachedClass: "label label-reception",
            alwaysShow: true,
            threshold: 5
        });
    }
